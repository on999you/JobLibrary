...
/**
 * Created by ChiShun on 26/4/2017.
 */
public class MainPageActivity extends BaseActivity {
    ...
    public void searchJobNow(View v){
    ...
    class getCriteriasAsyncTaskRunner extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            loadingInternetDialog = new ProgressDialog(MainPageActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            if(jobCatItemList == null || jobCatItemList.isEmpty()) {
                Toast.makeText(MainPageActivity.this, "cannot get job cat", Toast.LENGTH_LONG).show();
            } else {
                //Get Job Cat
            ...
            if(industryItemList == null || industryItemList.isEmpty()) {
                Toast.makeText(MainPageActivity.this, "cannot get job industry", Toast.LENGTH_LONG).show();
            } else {
                //Get Job Industry
